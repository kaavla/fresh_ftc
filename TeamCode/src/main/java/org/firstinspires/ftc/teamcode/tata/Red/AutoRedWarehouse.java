...
public class AutoRedWarehouse extends tataAutonomousBase {
    public Pose2d startPose = new Pose2d(18, -63.5, Math.toRadians(270));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData( "IMU  %2f", imuParams.correctedHeading );
        ...
        TrajectorySequence moveToStartCarousel = getTrajectorySequenceBuilder()
                .turn(-1*Math.toRadians(imuParams.correctedHeading - 270))
                .strafeLeft(dsParams.x_RS - 1)
                .waitSeconds(0.2)
