...
public class BlueInAutoFreight2 implements MeepMeepPath{
	...
	public TrajectorySequence getTrajectorySequence( DriveShim drive ) {
		return drive.trajectorySequenceBuilder( new Pose2d( 0, 61, Math.toRadians( 90 ) ) )
...
//					robot.liftToShippingHubHeight( RRHexBot.ShippingHubHeight.HIGH );
				...
				.setTangent( Math.toRadians( 90 ) )
				.splineToSplineHeading( new Pose2d( 18, wallPos, Math.toRadians( 0 ) ), Math.toRadians( 0 ) )
				//.splineToSplineHeading( MeepMeepPath.getHubPosition( 55, 0, 7, true ), Math.toRadians( 0 ) )
...
//					robot.lift.setDefaultHeightVel( 1200 );
				...
				.setTangent( Math.toRadians( 90 ) )
				.splineToSplineHeading( new Pose2d( 18/*49*/, wallPos, Math.toRadians( 0 ) ), Math.toRadians( 0 ) )
